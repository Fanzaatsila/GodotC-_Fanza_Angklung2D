...
public partial class Primitif: RefCounted
{
	...
	public List<Vector2> SegitigaSiku(Vector2 titikAwal, float alas, float tinggi)
	{
		List<Vector2> res = new List<Vector2>();
	...
	public List<Vector2> SegitigaSamaKaki(Vector2 titikAwal, float alas, float tinggi)
	{
		List<Vector2> res = new List<Vector2>();
		float setengahAlas = alas / 2;
		res.AddRange(LineBresenham(titikAwal.X, titikAwal.Y, titikAwal.X - setengahAlas, titikAwal.Y + tinggi)); // sisi kiri
		res.AddRange(LineBresenham(titikAwal.X - setengahAlas, titikAwal.Y + tinggi, titikAwal.X + setengahAlas, titikAwal.Y + tinggi)); // sisi alas
		res.AddRange(LineBresenham(titikAwal.X + setengahAlas, titikAwal.Y + tinggi, titikAwal.X, titikAwal.Y)); // sisi kanan
		return res;
	}
	...
	{
		List<Vector2> res = new List<Vector2>();
		float selisih = (panjangBawah - panjangAtas) / 2;
		float awalBawahX = Mathf.FloorToInt(titikAwal.X - selisih); // Use Mathf.FloorToInt for clarity
		res.AddRange(LineBresenham(titikAwal.X, titikAwal.Y, titikAwal.X + panjangAtas, titikAwal.Y)); // sisi atas
	...
	public List<Vector2> CircleMidPoint(float xCenter, float yCenter, float radius)
	{
	...
	private void CirclePlotPoints(float xCenter, float yCenter, float x, float y, List<Vector2> points)
	{
	...
	public List<Vector2> EllipseMidpoint(float xCenter, float yCenter, float rx, float ry)
	{
		List<Vector2> points = new List<Vector2>();
	...
	private void EllipsePlotPoints(float xCenter, float yCenter, float x, float y, List<Vector2> points)
	{
		points.Add(new Vector2(xCenter + x, yCenter + y));
		points.Add(new Vector2(xCenter - x, yCenter + y));
		points.Add(new Vector2(xCenter + x, yCenter - y));
