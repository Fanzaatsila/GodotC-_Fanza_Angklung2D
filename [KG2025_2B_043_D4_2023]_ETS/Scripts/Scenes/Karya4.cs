...
public partial class Karya4 : Node2D
{
	...
	private void changeAnimationSpeed()
	{
		...
		{
			// Ubah teks dalam Label
			speed.Text = "Animation Speed: 0.75x";
			bungaRotationSpeed = 90 * 0.75f;
			angklungRotationSpeed = 90 * 0.75f;
		}
		else if (moveSpeed == -1)
		{
			// Ubah teks dalam Label
			speed.Text = "Animation Speed: 0.5x";
			bungaRotationSpeed = 90 * 0.5f;
			angklungRotationSpeed = 90 * 0.5f;
		}
		else if(moveSpeed == -2)
		{
			// Ubah teks dalam Label
			speed.Text = "Animation Speed: 0.25x";
			bungaRotationSpeed = 90 * 0.25f;
			angklungRotationSpeed = 90 * 0.25f;
		}
		else if (moveSpeed <= -3)
		{
			// Ubah teks dalam Label
			speed.Text = "Animation Speed: 0x";
			moveSpeed = -3;
			bungaRotationSpeed = 0;
			angklungRotationSpeed = 0;
		}
		else
		{
			// Ubah teks dalam Label dengan moveSpeed
			speed.Text = $"Animation Speed: {moveSpeed}x";
			bungaRotationSpeed = 90 * moveSpeed;
			angklungRotationSpeed = 90 * moveSpeed;
		}
	}
